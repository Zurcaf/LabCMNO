...
void IP_LQG_PCI6221_2015a_output(void)
{
  ...
  rtb_Sum1 = 0.0;
  for (ci = 0; ci < 5; ci++) {
    rtb_Sum1 += -IP_LQG_PCI6221_2015a_P.K[ci] *
  ...
  IP_LQG_PCI6221_2015a_B.Integrator1 = IP_LQG_PCI6221_2015a_X.Integrator1_CSTATE;

  /* Integrator: '<Root>/Integrator' */
  IP_LQG_PCI6221_2015a_B.Integrator = IP_LQG_PCI6221_2015a_X.Integrator_CSTATE;

  /* Sum: '<Root>/Sum1' */
  rtb_Sum1 = (rtb_Sum1 - IP_LQG_PCI6221_2015a_B.Integrator1) -
    IP_LQG_PCI6221_2015a_B.Integrator;

  /* Integrator: '<Root>/Integrator2' */
  IP_LQG_PCI6221_2015a_B.Integrator2 = IP_LQG_PCI6221_2015a_X.Integrator2_CSTATE;

  /* Sum: '<Root>/Sum' */
  IP_LQG_PCI6221_2015a_B.Sum = rtb_Sum1 - IP_LQG_PCI6221_2015a_B.Integrator2;
  if (rtmIsMajorTimeStep(IP_LQG_PCI6221_2015a_M)) {
  ...
  /* Gain: '<Root>/Gain' */
  IP_LQG_PCI6221_2015a_B.Gain_m = IP_LQG_PCI6221_2015a_P.Gain_Gain_f *
    IP_LQG_PCI6221_2015a_B.Sensorsswitch[0];

  /* Gain: '<Root>/Gain1' */
  IP_LQG_PCI6221_2015a_B.Gain1 = IP_LQG_PCI6221_2015a_P.Gain1_Gain *
    IP_LQG_PCI6221_2015a_B.Sensorsswitch[1];

  /* Gain: '<Root>/Gain2' */
  IP_LQG_PCI6221_2015a_B.Gain2 = IP_LQG_PCI6221_2015a_P.Gain2_Gain * rtb_Sum1;
  if (rtmIsMajorTimeStep(IP_LQG_PCI6221_2015a_M)) {
  }
}
...
void IP_LQG_PCI6221_2015a_derivatives(void)
{
  ...
  _rtXdot->Integrator1_CSTATE = IP_LQG_PCI6221_2015a_B.Gain1;

  /* Derivatives for Integrator: '<Root>/Integrator' */
  _rtXdot->Integrator_CSTATE = IP_LQG_PCI6221_2015a_B.Gain_m;

  /* Derivatives for Integrator: '<Root>/Integrator2' */
  _rtXdot->Integrator2_CSTATE = IP_LQG_PCI6221_2015a_B.Gain2;
}
...
void IP_LQG_PCI6221_2015a_initialize(void)
{
...

  {
    ...
    IP_LQG_PCI6221_2015a_X.Integrator1_CSTATE =
      IP_LQG_PCI6221_2015a_P.Integrator1_IC;

    /* InitializeConditions for Integrator: '<Root>/Integrator' */
    IP_LQG_PCI6221_2015a_X.Integrator_CSTATE =
      IP_LQG_PCI6221_2015a_P.Integrator_IC;

    /* InitializeConditions for Integrator: '<Root>/Integrator2' */
    IP_LQG_PCI6221_2015a_X.Integrator2_CSTATE =
      IP_LQG_PCI6221_2015a_P.Integrator2_IC;
...
RT_MODEL_IP_LQG_PCI6221_2015a_T *IP_LQG_PCI6221_2015a(void)
{
  ...
  /* External mode info */
  IP_LQG_PCI6221_2015a_M->Sizes.checksums[0] = (3494020454U);
  IP_LQG_PCI6221_2015a_M->Sizes.checksums[1] = (2267770745U);
  IP_LQG_PCI6221_2015a_M->Sizes.checksums[2] = (3229489770U);
  IP_LQG_PCI6221_2015a_M->Sizes.checksums[3] = (890953093U);
  ...
  /* Initialize Sizes */
  IP_LQG_PCI6221_2015a_M->Sizes.numContStates = (8);/* Number of continuous states */
  ...
  IP_LQG_PCI6221_2015a_M->Sizes.numBlocks = (50);/* Number of blocks */
  IP_LQG_PCI6221_2015a_M->Sizes.numBlockIO = (14);/* Number of block outputs */
  IP_LQG_PCI6221_2015a_M->Sizes.numBlockPrms = (80);/* Sum of parameter "widths" */
