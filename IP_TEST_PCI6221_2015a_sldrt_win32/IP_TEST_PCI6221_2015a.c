 ...
 * C source code generated on : Fri Mar 07 15:20:06 2025
 *
...
RT_MODEL_IP_TEST_PCI6221_2015a_T *IP_TEST_PCI6221_2015a(void)
{
  ...
  rtmSetTFinal(IP_TEST_PCI6221_2015a_M, 200.0);
  IP_TEST_PCI6221_2015a_M->Timing.stepSize0 = 0.01;
  IP_TEST_PCI6221_2015a_M->Timing.stepSize1 = 0.01;

  /* External mode info */
  IP_TEST_PCI6221_2015a_M->Sizes.checksums[0] = (2806661321U);
  IP_TEST_PCI6221_2015a_M->Sizes.checksums[1] = (894609193U);
  IP_TEST_PCI6221_2015a_M->Sizes.checksums[2] = (3008042976U);
  IP_TEST_PCI6221_2015a_M->Sizes.checksums[3] = (575693600U);
  ...
  IP_TEST_PCI6221_2015a_M->Sizes.numBlocks = (17);/* Number of blocks */
  IP_TEST_PCI6221_2015a_M->Sizes.numBlockIO = (3);/* Number of block outputs */
  IP_TEST_PCI6221_2015a_M->Sizes.numBlockPrms = (24);/* Sum of parameter "widths" */
